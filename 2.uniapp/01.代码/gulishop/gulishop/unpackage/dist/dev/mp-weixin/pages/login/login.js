...
/* harmony import */ var _login_vue_vue_type_template_id_c99ed932___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=c99ed932& */ 42);
    ...
    handleLogin: function handleLogin() {
      ...
      uni.getUserProfile({
        ...
        success: function success(res) {
          // console.log('res',res)
          var rawData = res.rawData,userInfo = res.userInfo;
          uni.setStorage({
            key: "userInfoStr",
            data: rawData });
