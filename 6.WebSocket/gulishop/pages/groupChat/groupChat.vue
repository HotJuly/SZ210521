<template>
	<view class="container">
			...
			<scroll-view scroll-y style="height: 100%;">
				...
				<view>
					<view class="item flex-row right">
						<image src="/static/images/pyy.png" class="face"></image>
						<view class="username" style="right:140rpx">深圳彭于晏</view>
						<view class="content flex-row">你觉得静哥怎么样?</view>
					</view>
				</view>
				<view>
					<view class="item flex-row left">
						<image src="/static/images/pyy.png" class="face"></image>
						<view class="username" style="left:140rpx">泉州吴彦祖</view>
						<view class="content flex-row">静哥真是一个大帅比,头发又多,说话又好听</view>
					</view>
				</view>
				<view id="bottom"></view>
			</scroll-view>
		...
		<view class="oper flex-row">
			...
			<!--发送-->
			<view v-show="content" class="btn">发送</view>
			<!--附件-->
